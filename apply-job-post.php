      ...
      $result = $conn->query($sql);
        ...
        <table align="center">
          ...
          <tr>
            <td></td>
            <td></td>
            <td><a href="mainlogin.php" style="background-color: #053a5a; border-color: transparent; border-radius: 5px; padding-left: 25px; padding-right: 25px; padding-top: 10px; padding-bottom: 13px; color: white; font-size: 24px; text-decoration: none;">Apply</a></td>
          </tr>
